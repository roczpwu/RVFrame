...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype.render = function() {
    var tpl;
    tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageUrl')) + "</label>\n    <input class=\"image-src\" type=\"text\" tabindex=\"1\" />\n    <a class=\"btn-upload\" href=\"javascript:;\"\n      title=\"" + (this._t('uploadImage')) + "\" tabindex=\"-1\">\n      <span class=\"simditor-icon simditor-icon-upload\"></span>\n    </a>\n  </div>\n  <div class='settings-field'>\n    <label>" + (this._t('imageAlt')) + "</label>\n    <input class=\"image-alt\" id=\"image-alt\" type=\"text\" tabindex=\"1\" />\n  </div>\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageSize')) + "</label>\n    <input class=\"image-size\" id=\"image-width\" type=\"text\" tabindex=\"2\" />\n    <span class=\"times\">×</span>\n    <input class=\"image-size\" id=\"image-height\" type=\"text\" tabindex=\"3\" />\n    <a class=\"btn-restore\" href=\"javascript:;\"\n      title=\"" + (this._t('restoreImageSize')) + "\" tabindex=\"-1\">\n      <span class=\"simditor-icon simditor-icon-undo\"></span>\n    </a>\n  </div>\n <div class=\"settings-field\">\n  <label>" + (this._t('imageMatchWidth')) + "</label>\n  <input class='image-size' id='width-scale' type='text' tabindex='2' style='width:84px' disabled>% \n  <input id='auto-width' type='checkbox' style='width: 16px; height: 16px; margin: auto'/> \n  </div> </div>";
    this.el.addClass('image-popover').append(tpl);
    this.srcEl = this.el.find('.image-src');
    this.widthEl = this.el.find('#image-width');
    this.heightEl = this.el.find('#image-height');
    this.altEl = this.el.find('#image-alt');
    this.autoWidth = this.el.find('#auto-width');
    this.widthScale = this.el.find('#width-scale');
    this.autoWidth.on('change', function(_this) {
      return function(e) {
        ischecked = _this.autoWidth[0].checked;
        if (ischecked) {
          _this.widthEl.attr('disabled', true);
          _this.heightEl.attr('disabled', true);
          _this.widthScale.attr('disabled', false);
        } else {
          _this.widthEl.attr('disabled', false);
          _this.heightEl.attr('disabled', false);
          _this.widthScale.attr('disabled', true);
        }
      };
    }(this));
  ...
  ImagePopover.prototype._resizeImg = function(inputEl, onlySetVal) {
    ...
    } else if (inputEl.is(this.heightEl)) {
      height = value;
      width = this.width * value / this.height;
      this.widthEl.val(width);
    }
    if (!onlySetVal) {
      if (!this.autoWidth[0].checked) {
        this.target.attr({
          width: width,
          height: height
      });} else {
        this.target.attr({
          width: this.widthScale[0].value + '%',
        });
